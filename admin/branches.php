...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($action === 'bulk_edit') {
                ...
                $stmt = db()->prepare("UPDATE branches SET geofence_radius=?, work_start_time=?, work_end_time=?, check_in_start_time=?, check_in_end_time=?, check_out_start_time=?, check_out_end_time=?, checkout_show_before=?, allow_overtime=?, overtime_start_after=?, overtime_min_duration=?, is_active=?");
                $stmt->execute([
                    $radius,
                    $wsTime,
                    $weTime,
                ...
                $message = "تم تطبيق التعديلات الجماعية على جميع الفروع (عدا الاسم والإحداثيات)";
                $msgType = 'success';
            }
    ...
    <div class="modal-branch">
        ...
        <form method="POST">
            ...
            <div class="modal-branch-body">
                ...
                <div class="form-section">أوقات الدوام</div>
                <div class="form-row col3">
                    <div class="form-group">
                        <label class="form-label">بدء الدوام</label>
                        <input class="form-control" type="time" name="work_start_time" value="08:00">
                    </div>
                    <div class="form-group">
                        <label class="form-label">نهاية الدوام</label>
                        <input class="form-control" type="time" name="work_end_time" value="16:00">
                    </div>
                    <div class="form-group">
                        <label class="form-label">عرض الانصراف قبل (دقيقة)</label>
                        <input class="form-control" type="number" name="checkout_show_before" value="30" min="0">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="time" name="check_in_start_time" value="07:00">
                    </div>
                    <div class="form-group">
                        <label class="form-label">نهاية تسجيل الدخول</label>
                        <input class="form-control" type="time" name="check_in_end_time" value="10:00">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label class="form-label">بدء الانصراف</label>
                        <input class="form-control" type="time" name="check_out_start_time" value="15:00">
                    </div>
                    <div class="form-group">
                        <label class="form-label">نهاية الانصراف</label>
                        <input class="form-control" type="time" name="check_out_end_time" value="20:00">
                    </div>
                </div>
